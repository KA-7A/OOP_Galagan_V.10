           ...
           scanf("%d", &choice);
            ...
            switch (choice) {
                ...
                case 4:
                {
                    ...
                    switch (t.checkTimetable(linesList)) {
                        case 0: {
                        ...
                        case -1:
                        {
                            std::cout << " Error: Station(s) with name(s) was(were) not found in line " << std::endl;
                            break;
                        }
                        case -2:
                        {
                        ...
                        case -3:
                        {
                            std::cout << " Error: Wrong time in timetable!" << std::endl;
                            break;
                        }
                        case -4:
                        {
                            std::cout << " Error: No stations in timetable!" << std::endl;
                            break;
                        }
                        default:
                        {
                            std::cout << " Strange things... How did u got that?" << std::endl;
                            break;
                        }
                    }
                    break;
